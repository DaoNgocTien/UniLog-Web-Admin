...
import {
  ...
  const ServerDetailModalPresentation = ({ fromProps }) => {
    let {
      modal,
    ...
    const isActiveCheckRef = React.createRef();
    ...
    const [
      ...
      setServerCreateDateValidation
    ] = useState(null);
    const [
        serverUpdateDateValidation,
      setServerUpdateDateValidation
    ] = useState(null);
    ...
    const checkValidation = async event => {
      ...
      switch (name) {
        case "serverIpAddress":
          setServerIpAddressValidation(
            validateIPaddress({ [name]: value })
          );
          break;
  
        case "serverCode":
          setServerCodeValidation(
            validateServerCode({ [name]: value })
          );
          break;
  
        case "serverName":
          setServerNameValidation(
            validateServerName({ [name]: value })
          );
          break;
        ...
        case "serverExpiredDate":
          setServerExpiredDateValidation(
            validateExpiredDate({ [name]: value })
          );
          break;
        ...
        case "serverOsSelect":
          ...
          setServerOsSelectValidation(
            validateServerTypeAndOS(condition)
          );
          break;
    ...
    const createServer = event => {
      ...
      const server = {
        ...
        create_date: serverCreateDateRef.current.value,
        update_date: serverUpdateDateRef.current.value,
  ...
  export default memo(ServerDetailModalPresentation, arePropsEqual);
